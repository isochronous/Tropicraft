...
public final class TropicraftBiomes {
    ...
    private static Biome createOsaRainforest(BootstapContext<Biome> context) {
        ...
        spawns.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(TropicraftEntities.GIBNUT.get(), 10, 3, 8));
        ...
        spawns.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(TropicraftEntities.KEEL_KILLED_TOUCAN.get(), 8, 1, 2));
    ...
    private static void addOceanWaterCreatures(MobSpawnSettings.Builder spawns) {
        ...
        spawns.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(TropicraftEntities.MANATEE.get(), 2, 1, 3));
    }
